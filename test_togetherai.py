...
#     messages=[{"role": "user", "content": "What are some fun things to do in New York? Please be concise and give 5 options."}]
...
getDescriptionPrompt = "Describe the cat on this image in great detail."

imagePath= "tmp_photo.jpg"
